...
class PipeRegister:
	...
	def __init__(self):
		...
		self.regM = {'stat':'AOK', 'icode':1, 'ifun':0, 'Cnd':0, 'valE':0, 'valA':0, 'dstE':RNONE, 'dstM':RNONE}

		self.regW = {'stat':'AOK', 'icode':1, 'ifun':0, 'valE':0, 'valM':0, 'dstE':RNONE, 'dstM':RNONE}
	...
	def get_ins(self):
		...
		else: ins.append(dic[self.regM['icode']*16+self.regM['ifun']])
		if self.regW['stat'] == 'INS':ins.append('<bad>')
		else: ins.append(dic[self.regW['icode']*16+self.regW['ifun']])
