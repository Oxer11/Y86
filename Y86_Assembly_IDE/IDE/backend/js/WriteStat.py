...
def WriteStat(cycle,stat,cpi,zf,sf,of):
    fr = '''<div><p id="cycle" style="font-size:80px;font-weight:700;text-align:center;color:white;background-color:rgb(147,112,219);padding-top:10px;padding-bottom:10px;">'''+str(cycle)+'''</p></div>
